...
class TableRow extends Component {
    ...
    render(){
        ...
        for(let i =0;i<this.props.columnsInfo.length;i++){
            columnsCell.push(
                <Cell key = {i} rowID ={this.state.rowID} columnID ={i} patientColumnData = {this.props.patientData[this.props.columnsInfo[i]['attributename']]} columnName = {this.props.columnsInfo[i]['attributename']}
